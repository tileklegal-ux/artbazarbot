TEXTS = {
    ...
    "cabinet_status_free": "Статус: базалык режим (күндө 3 суроо лимит).",
    "cabinet_usage_today": "Бүгүнкү суроолор: {count}.",
    "cabinet_history_header": "Акыркы суроолордун тарыхы:",
    "cabinet_history_empty": "Тарых азырынча бош. Биринчи анализди жасап көр.",
}
