...
def get_texts(user_id: int):
    ...
    if lang == "kg":
        return {
            ...
            "premium_free": (
                "Азыр сен базалык режимдесиң.\n"
                "Бардык функциялар ачык, бирок күнүнө *3 суроо* лимит бар.\n\n"
                "Премиумда суроолорго чектөө жок жана жооптор приоритеттүү."
            ),
            "premium_info_no": (
                "Премиум азыр активдүү эмес.\n\n"
                "Базалык тариф — бардык функциялар ачык, бирок *3 суроо күнүгө*.\n\n"
                "Премиум режимде:\n"
                "• чектөөсүз суроолор\n"
                "• терең анализ\n"
    ...
    if lang == "kz":
        return {
            ...
            "premium_free": (
                "Қазір сен базалық режимдесің.\n"
                "Барлық функция ашық, бірақ күніне *3 сұраққа* дейін.\n\n"
                "Премиумда шектеу жоқ және жауаптар приоритетпен беріледі."
            ),
            "premium_info_no": (
                "Премиум қосылмаған.\n\n"
                "Базалық тариф — барлық функция ашық, бірақ *күніне 3 сұрақ*.\n\n"
                "Премиум режимде:\n"
                "• шексіз сұрақтар\n"
                "• терең талдау\n"
    ...
    return {
        ...
        "premium_free": (
            "Сейчас у тебя базовый доступ.\n"
            "Все функции открыты, но есть лимит — *3 запроса в сутки*.\n\n"
            "Премиум снимает все ограничения и даёт приоритетные ответы."
        ),
        "premium_info_no": (
            "Премиум-доступ пока не активирован.\n\n"
            "В бесплатном тарифе ты можешь сделать *3 запроса в день* "
            "по любым функциям.\n\n"
            "В Премиум-доступе:\n"
            "• безлимитные запросы\n"
...
async def admin_button(message: Message):
    ...
    await message.answer(
        ...
        "Позже здесь будет управление менеджерами, премиум-доступом и статистикой."
    )
